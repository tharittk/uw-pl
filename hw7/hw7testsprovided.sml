...
let 
	val LineSegment(a,b,c,d) = preprocess_prog (LineSegment(3.2,2.1,3.2,1.1))
	val LineSegment(e,f,g,h) = LineSegment(3.2,1.1,3.2,2.1)
in
	if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
	then (print "preprocess flips an improper LineSegment successfully (Tied x)\n")
	else (print "preprocess does not flip an improper LineSegment successfully\n")
end;

let 
	val LineSegment(a,b,c,d) = preprocess_prog (LineSegment(3.2,2.1,3.2,3.1))
	val LineSegment(e,f,g,h) = LineSegment(3.2,2.1,3.2,3.1)
in
	if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
	then (print "preprocess flips an improper LineSegment successfully (Tied x yet unchange)\n")
	else (print "preprocess does not flip an improper LineSegment successfully\n")
end;


let 
	val LineSegment(a,b,c,d) = preprocess_prog (LineSegment(1.2,2.1,3.2,1.1))
	val LineSegment(e,f,g,h) = LineSegment(1.2,2.1,3.2,1.1)
in
	if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
	then (print "preprocess flips an improper LineSegment successfully (unchange)\n")
	else (print "preprocess does not flip an improper LineSegment successfully\n")
end;
