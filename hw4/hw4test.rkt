...
(define tests
  (test-suite
   ...
   (check-equal? (sequence 0 5 2) (list 0 2 4) "Sequence test noTail")
   (check-equal? (sequence 0 5 5) (list 0 5) "Sequence test justEnd")
   (check-equal? (sequence 3 3 2) (list 3) "Sequence test startEqStop")
   (check-equal? (sequence 4 3 2) (list ) "Sequence test low more high")
   ...
   (check-equal? (string-append-map 
                  (list "dan") 
                  "") '("dan") "string-append-map empt")
   (check-equal? (string-append-map 
                  (list ) 
                  "jpg") '() "string-append-map empt")
